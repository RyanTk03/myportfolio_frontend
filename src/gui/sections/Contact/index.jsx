...
const successContent = (
    <>
        ...
        <p className="bold-text">
            ...
            I&apos;ll do our best to process it within 2 business days
        </p>
    </>
);
...
const Contact = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        startTransition(async () => {
            try {
                ...
                setResult({ sent: false, error: e.message });
            }
        });
    };
    ...
    const formContent = (
        ...
        <h2 className="head-text">
            Ready to start your next project?<br />Contact me now!
        </h2>
        <p className="bold-text">
            Let&apos;s find how I can help you bring your vision to life.
        </p>
